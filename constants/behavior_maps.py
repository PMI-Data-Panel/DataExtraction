...
# 10. 커피 머신 보유 (실제 질문: "보유가전제품")
COFFEE_QUESTION_KEYWORDS = {
    "보유가전제품", "가전제품", "보유", "소유", "커피"
}
COFFEE_ANSWER_VALUES = {
    "보유함": ["커피 머신", "커피머신", "에스프레소 머신", "캡슐커피 머신",
              "캡슐커피", "네스프레소", "돌체구스토"],
    "보유 안함": []
}
...
HOME_APPLIANCE_ANSWER_VALUES = {
    "가전제품 관심 있음": ["TV", "냉장고", "세탁기", "에어컨", "청소기", "공기청정기",
                        "로봇청소기", "식기세척기", "건조기", "인덕션"],
    "가전제품 관심 없음": ["가전제품 관심 없음", "구매 계획 없음", "해당 없음"]
}

# 23. 스마트 기기 보유 (실제 질문: "보유가전제품")
SMART_DEVICE_QUESTION_KEYWORDS = {
    "보유가전제품", "가전제품", "보유", "소유", "스마트"
}
SMART_DEVICE_ANSWER_VALUES = {
    "보유함": ["인공지능 AI 스피커", "AI 스피커", "AI스피커",
              "로봇청소기", "로봇 청소기",
              "스마트 워치", "스마트워치", "애플워치", "갤럭시 워치",
              "식기세척기", "의류 관리기", "스타일러"],
    "보유 안함": ["스마트기기 관심 없음", "사용 안함", "해당 없음", "보유하지 않음"]
}
...
# ⚠️ 기존 DINING_OUT_QUESTION_KEYWORDS는 SOLO_DINING_QUESTION_KEYWORDS와 통합됨
...
BEHAVIORAL_KEYWORD_MAP = {
    ...
    'drinks_coffee': {
        'question_text': '보유가전제품',
        'question_keywords': COFFEE_QUESTION_KEYWORDS,
        'answer_values': COFFEE_ANSWER_VALUES,
        'positive_keywords': set(),
        'negative_keywords': set()
    },
    'has_subscription': {
    ...
    'uses_smart_devices': {
        ...
        'answer_values': SMART_DEVICE_ANSWER_VALUES,
        'positive_keywords': set(),
        'negative_keywords': set()
    },
